...
<div class="loginWrapper">
	<div class="loginLogo"><img src="<?php echo url::base(null, true); echo Kohana::$config->load('local')->get('asset_dir'); ?>/admin/images/loginLogo.png" alt="" /></div>
    <div class="loginPanel">
        <div class="head"><h5 class="iUser">Acceso Restringido</h5></div>
        <form id="valid" class="mainForm" method="post" action="/admin/main/login">
            <fieldset>
